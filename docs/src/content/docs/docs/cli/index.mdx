...
| [`config`](/docs/cli/config/)                              | All platforms | Set up machine configuration.                                  |
...
| [`self-update`](/docs/cli/self-update/) (alias: `upgrade`) | All platforms | Replace the manager binary with the latest release.            |
