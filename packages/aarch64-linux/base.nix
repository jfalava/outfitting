# Work Home Manager configuration for Ubuntu ARM

{ config, pkgs, ... }:

let
  # Repository path in local checkout mode
  outfittingRepo = "${config.home.homeDirectory}/.config/outfitting/repo";

in
{
  # Basic home manager settings
  home.username = "jalava";
  home.homeDirectory = "/home/jalava";
  ...
  home.file = {
    ".zshrc".source = "${outfittingRepo}/dotfiles/.zshrc-ubuntu-arm";
  ...
  home.sessionVariables.AWS_PROFILE = "default";
  home.sessionVariables.AWS_REGION = "us-east-1";
