...
Run the post-install script in an elevated PowerShell session after the main
installer. It performs post-install work and installs licensed fonts for all
local users.
